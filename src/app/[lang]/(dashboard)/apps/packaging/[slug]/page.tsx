...
import EditPackagingActions from '@/views/apps/packaging-type/edit/PackagingTypeAddAction'
...
const Page = () => {
  ...
  useEffect(() => {
    const fetchPackaging = async () => {
      try {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_URL}/package/get-packaging/${slug}`, { withCredentials: true })
  ...
  return (
    <div>
      <EditPackagingActions data={data} id={slug} />
    </div>
  )
}
