...
const EditPackageTypeActions = ({ data, id }: { data?: any, id?: any }) => {
  // States
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      const response = await axios
        .put(`${process.env.NEXT_PUBLIC_BACKEND_URL}/package-type/update-packaging/${id}`, data, { withCredentials: true })
        .then(res => {
          toast.success('Packaging Types Updated Successfully!')
          fetchPackagingType()
...
export default EditPackageTypeActions
