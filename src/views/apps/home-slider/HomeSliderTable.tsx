...
const HomeSliderTable = ({ tableData }: { tableData?: UsersType[] }) => {
  // States
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({ row }) => (
          <div className='flex items-center gap-0.5'>
            ...
            <IconButton size='small'>
              <Link href={getLocalizedUrl(`/apps/home-sliders/${row.original._id}`, locale as Locale)} className='flex'>
  ...
  return (
    <Card>
      <CardHeader title='Home Banners Sliders' className='pbe-4' />
      <Divider />
      <CardContent className='flex justify-end flex-col items-start sm:flex-row sm:items-center max-sm:gap-4'>
        ...
        <div className='flex hidden flex-col !items-start max-sm:is-full sm:flex-row sm:items-center gap-4'>
          <DebouncedInput
            value={globalFilter ?? ''}
