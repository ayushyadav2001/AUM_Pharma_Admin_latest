...
const CategoryIndexing = ({ tableData }: { tableData?: any[] }) => {
  ...
  const updateCategoryIndexes = async (updatedCategories: any[]) => {
    try {
      await axios.put(`${process.env.NEXT_PUBLIC_BACKEND_URL}/categories/updateIndexes`, { categories: updatedCategories }, {
        headers: {
  ...
  return (
    <DndProvider backend={HTML5Backend}>
      <div>
        <h5> Change Listing Categories Positions</h5>
