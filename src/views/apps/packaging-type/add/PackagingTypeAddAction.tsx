  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      const response = await axios
        .post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/packaging-type/add-packaging`, data, { withCredentials: true })
        .then(res => {
          toast.success('Packaging Types  Added Successfully!')
          fetchPackagingType()
          router.push('/apps/packaginge-type')
        })
    } catch (error) {
...
export default AddPackagingTypeActions
