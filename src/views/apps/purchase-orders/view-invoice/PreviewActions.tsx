...
const PreviewActions = ({ id, onButtonClick, handleButtonClickPDF }: { id: string; onButtonClick: () => void, handleButtonClickPDF: () => void }) => {
  // States
    ...
    <>
      <Card>
        <CardContent className='flex flex-col gap-4'>
          ...
          <Button fullWidth color='secondary' onClick={handleButtonClickPDF} variant='outlined' className='capitalize'>
            Download
          </Button>
