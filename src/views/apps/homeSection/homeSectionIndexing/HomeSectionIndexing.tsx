...
const HomSectionIndexing = ({ tableData }: { tableData?: any[] }) => {
  ...
  const updateCategoryIndexes = async (updatedCategories: any[]) => {
    try {
      await axios.put(`${process.env.NEXT_PUBLIC_BACKEND_URL}/home-section/update-index`, { sections: updatedCategories }, {
  ...
  return (
    <DndProvider backend={HTML5Backend}>
      <div>
        <h5 className='mb-4'> Change Sections Positions</h5>
...
export default HomSectionIndexing;
